...
export function InitializeModuleModal({
  isOpen,
  onClose,
  onAddView,
  existingViews,
        ...
        {availableViewTypes.map((view) => {
          ...
          return (
            <button
              ...
              className={`
                flex items-center justify-between p-6 border transition-all text-left uppercase tracking-[0.2em] font-bold text-[10px] rounded-3xl
                ${
                  isAlreadyAdded
